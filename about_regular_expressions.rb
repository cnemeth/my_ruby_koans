...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # 
    # see http://stackoverflow.com/questions/5084141/getting-the-star-regex-operator-to-fail
  end
  ...
  def test_caret_anchors_to_the_start_of_lines
    assert_equal "2", "num 42\n2 lines"[/^\d+/] # matches '2' at the beginning of the 2nd line
  end
  ...
  # http://vintharas-development.wikispaces.com/about_regular_expressions.rb
