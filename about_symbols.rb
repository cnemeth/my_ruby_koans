...
class AboutSymbols < EdgeCase::Koan
  ...
  in_ruby_version("mri") do
    ...
    def test_constants_become_symbols
      ...
      assert_equal false, all_symbols.include?(":")
    end
  end
  ...
  # 
  # take up a lot of memory that cannot be freed until the program terminates
  # because symbols cannot be garbage collected
end
